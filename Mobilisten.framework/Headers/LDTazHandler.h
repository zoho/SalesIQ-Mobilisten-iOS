...
/**
 TazHandler is a class for providing the notifications of messages. The taz messages will be available in all the connections and services. The taz messages will have a storage in the services.
 */
@interface TazHandler : NSObject
<LDMessageInterface>
/**
