...
/**
 CollaborationHandler is a class for providing the notifications of messages. The collaboration messages will be available in all the connections and services. The collaboration messages will have a storage in the services.
 */
@interface CollaborationHandler : NSObject
<LDMessageInterface>
/**
