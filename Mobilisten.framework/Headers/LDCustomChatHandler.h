...
/**
 Handler used for creating and managing custom chat. In customchat, chat will be received in all services.
 */
@interface LDCustomChatHandler : NSObject
<LDMessageInterface>
/**
