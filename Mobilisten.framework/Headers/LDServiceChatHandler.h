//
//  LDServiceChatHandler.h
//  LDZohoMessenger
//
//  Created by Balaji Sankar on 24/02/14.
...
/**
 Service chat is the chat which can be used specifically by a single service. Message transfer will be handled by wms, other things like transcript,UI etc. should be handled by the service. In servicechat chat will be received only in the specific service.
 */
@interface LDServiceChatHandler : NSObject
<LDMessageInterface>
/**
