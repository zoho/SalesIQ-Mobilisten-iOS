...
/**
 LDChatHandler is a class for providing the notifications of chat messages. The chat messages will be available in all the services.
 */
@interface LDChatHandler : NSObject
<LDMessageInterface>
/**
 ...
 * @param lmTime last message time of chat.
 * @param messageInfo complete details from server
 */
