...
/**
 PresenceGroup is used for notifying presence group information. The messages will be notified to all the connections. The messages will be used by the corresponding product alone. The messages will be stored in a corresponding service.
 */
@interface PresenceGroupHandler : NSObject
<LDMessageInterface>
/**
